...
class BashShell(AutoCompletableShell):
    ...
    def _detect_bash_prompt(self):
        ...
        """
        LOGGER.log(_LOGLEVEL, "Trying to detect bash prompt...")
        ...
        LOGGER.log(_LOGLEVEL, '_read_until returned: "%s"', res)
        ...
        LOGGER.log(_LOGLEVEL, "Detected prompt '%s'", detected_prompt)
